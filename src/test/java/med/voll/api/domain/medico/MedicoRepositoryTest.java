...
class MedicoRepositoryTest {
    ...
    void escolherMedicoAleatorioLivreDataCenario1() {
        // given ou arrange
        var proxima_SegundaAs10 = LocalDate.now()
                .with(TemporalAdjusters.next(DayOfWeek.MONDAY))
                .atTime(10,0);

        var medico = cadastrarMedico("Medico", "medico@voll.med", "123456", Especialidade.CARDIOLOGIA);
        var paciente = cadastrarPaciente("Paciente", "paciente@email.com", "00000000000");
        cadastrarConsulta(medico, paciente, proxima_SegundaAs10);

        //when ou act
        var medicoLivre = medicoRepository.escolherMedicoAleatorioLivreData(Especialidade.CARDIOLOGIA, proxima_SegundaAs10);
